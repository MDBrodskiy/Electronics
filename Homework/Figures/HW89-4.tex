...
% Text Node
\draw (50.63,301.46) node [anchor=north west][inner sep=0.75pt]  [xscale=0.8,yscale=0.8]  {$V_{s}$};
% Text Node
\draw (99.89,253.22) node [anchor=north] [inner sep=0.75pt]  [xscale=0.8,yscale=0.8]  {$R_{S} =500[ \si{\ohm}]$};
% Text Node
\draw (358.45,298.84) node [anchor=east] [inner sep=0.75pt]  [xscale=0.8,yscale=0.8]  {$ \begin{array}{l}
R_{\pi } =\\
1.3\left[\text{k} \si{\ohm}\right]
\end{array}$};
% Text Node
\draw (179.49,234.25) node [anchor=north] [inner sep=0.75pt]  [xscale=0.8,yscale=0.8]  {$+$};
% Text Node
\draw (179.49,298.5) node  [xscale=0.8,yscale=0.8]  {$V_{in}$};
% Text Node
\draw (179.49,362.75) node [anchor=south] [inner sep=0.75pt]  [xscale=0.8,yscale=0.8]  {$-$};
% Text Node
\draw (388.04,298.84) node [anchor=west] [inner sep=0.75pt]  [xscale=0.8,yscale=0.8]  {$\beta I_{b}$};
% Text Node
\draw (395.06,253.14) node [anchor=west] [inner sep=0.75pt]  [xscale=0.8,yscale=0.8]  {$ \begin{array}{l}
R_{C} =\\
900[ \si{\ohm}]
\end{array}$};
% Text Node
\draw (568.72,289.14) node [anchor=west] [inner sep=0.75pt]  [xscale=0.8,yscale=0.8]  {$ \begin{array}{l}
R_{L} =\\
15\left[\text{k} \si{\ohm}\right]
\end{array}$};
% Text Node
\draw (338.4,195.94) node [anchor=north] [inner sep=0.75pt]  [xscale=0.8,yscale=0.8]  {$R_{B} =101.6\left[\text{k} \si{\ohm}\right]$};
% Text Node
\draw (518.79,232.34) node [anchor=north] [inner sep=0.75pt]  [xscale=0.8,yscale=0.8]  {$+$};
% Text Node
\draw (518.79,296.6) node  [xscale=0.8,yscale=0.8]  {$V_{o}$};
% Text Node
\draw (518.79,360.85) node [anchor=south] [inner sep=0.75pt]  [xscale=0.8,yscale=0.8]  {$-$};
% Text Node
\draw (229.34,218.98) node [anchor=south] [inner sep=0.75pt]  [xscale=0.8,yscale=0.8]  {$I_{b}$};
