...
% Text Node
\draw (147.42,210.09) node [anchor=north west][inner sep=0.75pt]    {$R_{B}=101.6[\si{\kilo\ohm}]$};
% Text Node
\draw (402.27,125.24) node [anchor=north west][inner sep=0.75pt]    {$R_{C}=.9[\si{\kilo\ohm}]$};
% Text Node
